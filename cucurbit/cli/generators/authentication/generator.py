...
from cucurbit.cli.generators.migrations import generator as migrations
from cucurbit.cli.generators.src_modifier import add_routes, add_imports, add_base_cls
...
def _template(*, path):
    return template('cucurbit.cli.generators.authentication', path=path)
