...
from cucurbit.actions import decorate_action, get_actions, register_actions
from cucurbit.rules import bind_rules
...
class MessageBuilder:
    def __init__(self, *,
        ...
        self.from_ = from_ or 'no-reply@cucurbit.me'  # TODO: Make it configurable
        self.to = to
