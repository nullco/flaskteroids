import pytest
from cucurbit.cli.generators.controller.generator import generate


@pytest.fixture
def artifacts_builder(mocker):
    mock_builder = mocker.patch('cucurbit.cli.generators.controller.generator.ArtifactsBuilder')
    mock_ab = mocker.Mock()
